...
const Navbar = () => {
    ...
    return (
        <header className='sticky top-0 w-full border-slate-100 bg-white'>
            ...
            <div className='mx-auto flex max-w-6xl items-center justify-between px-5 py-4'>
                ...
                <nav className='hidden md:flex'>
                    <ul className='flex items-center gap-6'>
                        <li>
                         ...
                         <li>
                            <a href='technologies'className='text-sm font-medium text-slate-600 hover:text-slate-900'>
                                Technologies
                ...
                <div className='flex items-center gap-4'>
                    <a href='#sign in' className='text-sm font-semibold text-slate-700 hover:text-slate-900'>
                        Sign in
                    </a>
